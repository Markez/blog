...
//    **----------
    ...
    function ChatHeight() {
        ...
        var RightBarTabHeight = $(".rightbar-tab").outerHeight(),
            ChatToolbarHeight = $(".chat-registration-toolbar").outerHeight(),
        ...
        $(".chat-registration-container").css({
            "height": ChatContainerHeight + "px"
        });

        $(".chat-registration-container").slimscroll({
    ...
    $(".chat-registration-list > li > div").popover({
        html: true,
        container: ".rightbar",
        delay: {
            "show": 100,
    ...
    $('body').on('click', function(e) {
        $('.chat-registration-list > li > a').each(function() {
    ...
    // **------------------
    $(".chat-registration-list > li > div, .chat-back").hammer().on("click touchstart", function(e) {
        e.preventDefault();
    ...
    $(".registration-details-toggle").each(function() {
        var $user = $(this).parents(".registration-intro").next(".users-details");
    ...
    $(".registration-details-toggle").on("click", function() {
        var $user = $(this).parents(".registration-intro").next(".users-details");
        var $ui = $(this).children("i");
        if ($user.is(':visible')) {
            $ui.removeClass("zmdi-minus");
