    ...
    function layer(selection) {
        selection.each(function(data) {
            ...
            function mouseHandler() {
                ...
                //If registration double clicks the layer, fire a elementDblclick
                ...
                // if registration single clicks the layer, fire elementClick
...
nv.models.boxPlot = function() {
    ...
    var margin = {top: 0, right: 0, bottom: 0, left: 0}
        , width = 960
        , height = 500
        , id = Math.floor(Math.random() * 10000) //Create semi-unique ID in case registration doesn't select one
        , x = d3.scale.ordinal()
        , y = d3.scale.linear()
...
nv.models.discreteBar = function() {
    ...
    var margin = {top: 0, right: 0, bottom: 0, left: 0}
        ...
        , getX = function(d) { return d.x }
        , getY = function(d) { return d.y }
        , forceY = [0] // 0 is forced by default.. this makes sense for the majority of bar graphs... registration can always do chart.forceY([]) to remove
        , color = nv.utils.defaultColor()
        , showValues = false
...
nv.models.scatter = function() {
    ...
    var margin       = {top: 0, right: 0, bottom: 0, left: 0}
        ...
        , id           = Math.floor(Math.random() * 100000) //Create semi-unique ID incase registration doesn't select one
        , container    = null
        , x            = d3.scale.linear()
        , y            = d3.scale.linear()
...
nv.models.stackedArea = function() {
    ...
    var margin = {top: 0, right: 0, bottom: 0, left: 0}
        ...
        , id = Math.floor(Math.random() * 100000) //Create semi-unique ID incase registration doesn't selet one
        , container = null
        , getX = function(d) { return d.x } // accessor to get the x value from a data point
        , getY = function(d) { return d.y } // accessor to get the y value from a data point
        , style = 'stack'
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            // If the registration has not specified forceY, make sure 0 is included in the domain
            // Otherwise, use registration-specified values for forceY
