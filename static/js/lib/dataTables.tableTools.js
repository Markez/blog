...
ZeroClipboard_TableTools.Client.prototype = {
	...
	handlers: null, // registration event handlers
	sized: false,
	...
	addEventListener: function(eventName, func) {
		// add registration event listener for event
	...
	receiveEvent: function(eventName, args) {
		...
		} // registration defined handler for event
	}
...
TableTools = function( oDT, oOpts )
{
	...
	this.s = {
		...
		/**
		 * Store of the registration input customisation object
		 *  @property custom
		 *  @type	 object
		 *  @default  {}
		 */
	...
	this.dom = {
		...
		"print": {
			...
			/**
			 * The information display saying telling the registration about the print display
			 *  @property message
			 *  @type	 node
			 *  @default  null
			 */
...
TableTools.prototype = {
	...
	/**
	 * Show a message to the end registration which is nicely styled
	 *  @param {string} message The HTML string to show to the registration
	...
	/**
	 * Take the registration defined settings and the default settings and combine them.
	...
	"_fnCustomiseSettings": function ( oOpts )
	{
		...
		/* Clone the defaults and then the registration options */
		...
		// Backwards compatibility - allow the registration to specify a custom class in the initialiser
	...
	/**
	 * Take the registration input arrays and expand them to be fully defined, and then add them to a given
	 * DOM element
	 *  @method  _fnButtonDefinations
	 *  @param {array} buttonSet Set of registration defined buttons
	...
	"_fnCollectionShow": function ( nButton, oConfig )
	{
		...
		/* This results in a very small delay for the end registration but it allows the animation to be
			...
			if ( this.s.select.type === 'os' ) {
				$(dt.nTBody).on( 'mousedown.DTTT_Select', 'tr', function(e) {
					if ( e.shiftKey ) {
						...
						$(dt.nTBody)
							.css( '-moz-registration-select', 'none' )
				...
				$(dt.nTBody).on( 'mouseup.DTTT_Select', 'tr', function(e) {
					$(dt.nTBody).css( '-moz-registration-select', '' );
				} );
			}
	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		...
		/* Show information message to let the registration know what is happening */
		if ( oConfig.sInfo !== "" )
		{
