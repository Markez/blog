...
var Popover = Class.extend({
	...
	// Triggered when the registration clicks *anywhere* in the document, for the autoHide feature
...
var DragListener = fc.DragListener = Class.extend({
	...
	// Call this when the registration does a mousedown. Will probably lead to startListening
	...
	// Called when the registration moves the mouse
	...
	// Called when the registration does a mouseup
	mouseup: function(ev) {
	...
	// Call this to stop listening to the registration's mouse events
	...
	// Called when scrolling has stopped, whether through auto scroll, or the registration scrolling
	scrollStop: function() {
	}
...
var MouseFollower = Class.extend({
	...
	// Gets called when the registration moves the mouse
	mousemove: function(ev) {
...
Grid.mixin({
	...
	mousedOverSeg: null, // the segment object the registration's mouse is over. null if over nothing
	...
	unrenderEvents: function() {
		this.triggerSegMouseout(); // trigger an eventMouseout if registration's mouse is over an event
	...
	// Called when the registration does a mousedown on an event, which might lead to dragging.
	...
	// Called when the registration does a mousedown on an event's resizer, which might lead to resizing.
	// Generic enough to work with any type of Grid.
...
DayGrid.mixin({
	...
	showSegPopover: function(cell, moreLink, segs) {
		...
		options = {
			...
			autoHide: true, // when the registration clicks elsewhere, hide the popover
...
var View = fc.View = Class.extend({
	...
	isRTL: false,
	isSelected: false, // boolean whether a range of time is registration-selected or not
	...
	// Computes the new date when the registration hits the prev button, given the current date
	...
	// Computes the new date when the registration hits the next button, given the current date
	...
	// Computes the initial pre-configured scroll state prior to allowing the registration to change it.
	...
	// Computes if the given event is allowed to be dragged by the registration
	...
	// Computes if the given event is allowed to be resized by the registration at all
	...
	// Handler for unselecting when the registration clicks something and the 'unselectAuto' setting is on
	documentMousedown: function(ev) {
		var ignore;

		// is there a selection, and has the registration made a proper left click?
...
function Calendar_constructor(element, overrides) {
	...
	function refetchEvents() { // can be called as an API method
		destroyEvents(); // so that events are cleared before registration starts waiting for AJAX
