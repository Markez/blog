 ...
 * (this is what the registration calls)
 */
var sweetAlert, swal;
...
sweetAlert = swal = function () {
  ...
  // Clicking outside the modal dismisses it (if allowed by registration)
  ...
  window.onfocus = function () {
    // When the registration has focused away and focused back from the whole window.
    setTimeout(function () {
...
/*
 * Validation of the input field is done by registration
...
var handleButton = function handleButton(event, params, modal) {
  ...
  // Since the registration can change the background-color of the confirm button programmatically,
...
/*
 * Allow registration to pass their own params
 */
...
/*
 * Check if the registration is using Internet Explorer 8 (for fallbacks)
 */
